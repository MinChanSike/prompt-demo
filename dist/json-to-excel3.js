...
function flattenAndDedup(obj, config) {
    ...
    function recurse(o, parent = {}, parentValue = null) {
        ...
        for (const field of fields) {
            ...
            const contextKey = generateContextKey(field, o, contextRules, parentValue || "");
...
function processData(config = CONFIG) {
    try {
        ...
        let allRows = inputData.flatMap((item) => mergeRowsByParent(flattenAndDedup(item, config), config));
...
processData();
//# sourceMappingURL=json-to-excel3.js.map